...
class _FileManagerPageState extends State<FileManagerPage>
    ...
    return Padding(
      ...
      child: Card(
        ...
        child: InkWell(
          ...
          onLongPress: () => _renameFile(fileInfo, index, isFavoriteTab),
          child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.pop(context);
                  _renameFile(fileInfo, index, isFavoriteTab);
                },
              ),
              ListTile(
  ...
  // 文件重命名功能
  void _renameFile(FileInfo fileInfo, int index, bool isFavoriteTab) {
